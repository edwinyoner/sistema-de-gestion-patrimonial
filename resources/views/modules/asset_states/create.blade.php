...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <x-adminlte-card title="Crear Nuevo Estado de Activo" theme="info" icon="fas fa-check-circle" collapsible>

                <form method="POST" action="{{ route('asset_states.store') }}">
                    @csrf

                    <x-adminlte-input name="name" label="Nombre del Estado de Activo" placeholder="Ej. NUEVO"
                    ...
                    <x-adminlte-textarea name="description" label="Descripción"
                        placeholder="Breve descripción del estado de activo" label-class="text-lightblue" rows="3"
                        igroup-size="md">
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-info">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="{{ route('asset_states.index') }}" class="btn btn-secondary btn-sm">
