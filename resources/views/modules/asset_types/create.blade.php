...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <x-adminlte-card title="Crear Nuevo Tipo de Activo" theme="info" icon="fas fa-plus" collapsible>

                <form method="POST" action="{{ route('asset_types.store') }}">
                    @csrf

                    <x-adminlte-input name="name" label="Nombre del Tipo de Activo" placeholder="Ej. EQUIPO DE OFICINA"
                    ...
                    <x-adminlte-textarea name="description" label="Descripción"
                        placeholder="Breve descripción del tipo de activo" label-class="text-lightblue" rows="3"
                        igroup-size="md">
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-info">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="{{ route('asset_types.index') }}" class="btn btn-secondary btn-sm">
