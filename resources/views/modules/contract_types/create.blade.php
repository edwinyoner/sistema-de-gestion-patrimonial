...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <x-adminlte-card title="Crear Nuevo Tipo de Contrato" theme="info" icon="fas fa-file-contract" collapsible>

                <form method="POST" action="{{ route('contract_types.store') }}">
                    @csrf

                    <x-adminlte-input name="name" label="Nombre del Tipo de Contrato" placeholder="Ej. NOMBRADO"
                    ...
                    <x-adminlte-textarea name="description" label="Descripción"
                        placeholder="Breve descripción del tipo de contrato" label-class="text-lightblue" rows="3"
                        igroup-size="md">
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-info">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="{{ route('contract_types.index') }}" class="btn btn-secondary btn-sm">
