...
@section('subtitle', 'Editar Cargo')
@section('content_header_title', 'Cargos')
@section('content_header_subtitle', 'Editar información del cargo')
...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <x-adminlte-card title="Editar Cargo" theme="warning" icon="fas fa-edit">
                ...
                <form method="POST" action="{{ route('job_positions.update', $jobPosition->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <x-adminlte-textarea
                        name="description"
                        label="Descripción"
                        placeholder="Actualiza la descripción del cargo"
                        label-class="text-lightblue"
                        rows="3"
                        igroup-size="md">{{ old('description', $jobPosition->description) }}
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-warning">
                    ...
                    <div class="form-group">
                        ...
                        <div class="toggle-container">
                            <div class="toggle-wrap">
                                <input type="hidden" name="status" id="status-value" value="{{ $jobPosition->status ? 1 : 0 }}">
                                <input class="toggle-input" id="holo-toggle" type="checkbox" {{ $jobPosition->status ? 'checked' : '' }} onchange="document.getElementById('status-value').value = this.checked ? 1 : 0;">
                        ...
                        <small class="form-text text-muted">Desactiva este cargo si no está en uso.</small>
                    </div>

                    <div class="d-flex justify-content-between mt-3">
                        <a href="{{ route('job_positions.index') }}" class="btn btn-sm btn-secondary">
