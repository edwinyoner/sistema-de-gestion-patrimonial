...
@section('content_header_subtitle', 'Editar información de la oficina')
...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <x-adminlte-card title="Editar Oficina" theme="warning" icon="fas fa-building">
                ...
                <form method="POST" action="{{ route('offices.update', $office->id) }}">
                    ...
                    <x-adminlte-textarea
                        name="description"
                        label="Descripción"
                        placeholder="Actualiza la descripción de la oficina"
                        label-class="text-lightblue"
                        rows="3"
                        igroup-size="md">{{ old('description', $office->description) }}
                        <x-slot name="prependSlot">
                            <div class="input-group-text bg-warning">
                    ...
                    <div class="form-group">
                        ...
                        <div class="toggle-container">
                            <div class="toggle-wrap">
                                <input type="hidden" name="status" id="status-value" value="{{ $office->status ? 1 : 0 }}">
                                <input class="toggle-input" id="holo-toggle" type="checkbox" {{ $office->status ? 'checked' : '' }} onchange="document.getElementById('status-value').value = this.checked ? 1 : 0;">
                        ...
                        <small class="form-text text-muted">Desactiva esta oficina si no está en uso.</small>
                    </div>

                    <div class="d-flex justify-content-between mt-3">
                        <a href="{{ route('offices.index') }}" class="btn btn-sm btn-secondary">
