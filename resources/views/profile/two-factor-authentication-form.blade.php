        ...
        <x-slot name="content">
            ...
            @if ($this->enabled)
                @if ($showingQrCode)
                    ...
                    @if ($showingConfirmation)
                        <div class="mt-4">
                            ...
                            <div class="text-danger mt-2" x-show="errors.code">
                ...
                @if ($showingRecoveryCodes)
                    ...
                    <div class="grid gap-1 mt-4 px-4 py-4 font-mono text-sm bg-light dark:bg-dark rounded">
                ...
                @else
                    @if ($showingRecoveryCodes)
                        <x-confirms-password wire:then="regenerateRecoveryCodes">
                            <button class="btn btn-secondary me-3" wire:loading.attr="disabled">
                                {{ __('Regenerate Recovery Codes') }}
                            </button>
                        </x-confirms-password>
                    @elseif ($showingConfirmation)
                        <x-confirms-password wire:then="confirmTwoFactorAuthentication">
                            <button type="button" class="btn btn-success me-3" wire:loading.attr="disabled">
                                {{ __('Confirm') }}
                            </button>
                        </x-confirms-password>
                    @else
